...
void HAL_TIMEx_HallSensor_MspInit(TIM_HandleTypeDef* timex_hallsensorHandle)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = Encoder_HALL_V_Pin|Encoder_HALL_U_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = Encoder_HALL_W_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(Encoder_HALL_W_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = Motor_PWM_AN_Pin|Motor_PWM_BN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = Motor_PWM_CN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM1;
    HAL_GPIO_Init(Motor_PWM_CN_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Motor_PWM_A_Pin|Motor_PWM_B_Pin|Motor_PWM_C_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM1;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA5     ------> TIM2_ETR
    */
    HAL_GPIO_DeInit(GPIOA, Encoder_A_Pin|Encoder_B_Pin|Encoder_Z_Pin);
...
void HAL_TIMEx_HallSensor_MspDeInit(TIM_HandleTypeDef* timex_hallsensorHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    HAL_GPIO_DeInit(GPIOA, Encoder_HALL_V_Pin|Encoder_HALL_U_Pin);

    HAL_GPIO_DeInit(Encoder_HALL_W_GPIO_Port, Encoder_HALL_W_Pin);
